...
void CiPlotX::SetDataViewZHorz(long newValue)
{
...
void CiPlotX::SetDataViewZVert(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetXYAxesReverse(BOOL newValue)
{
...
void CiPlotX::SetOuterMarginLeft(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetOuterMarginTop(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetOuterMarginRight(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetOuterMarginBottom(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetPrintOrientation(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetPrintShowDialog(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetUpdateFrameRate(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetBorderStyle(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetAutoFrameRate(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetHintsShow(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetHintsPause(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetHintsHidePause(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetTitleVisible(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetTitleText(LPCTSTR newValue)
{
...
void CiPlotX::SetUserCanEditObjects(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::AddDataArray(double XValue, VARIANT Data)
{
...
void CiPlotX::SetLogFileName(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR ;
...
void CiPlotX::SetLogBufferSize(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetOptionSaveAllProperties(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetHintsFont(COleFont newValue)
{
	static BYTE parms[] = VTS_DISPATCH ;
...
void CiPlotX::SetAnnotationDefaultFont(COleFont newValue)
{
	static BYTE parms[] = VTS_DISPATCH ;
...
void CiPlotX::SetAnnotationDefaultBrushStlye(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetAnnotationDefaultPenStlye(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetAnnotationDefaultPenWidth(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetWidth(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetHeight(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetUserCanAddRemoveChannels(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetVisible(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetEnabled(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetEditorFormStyle(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetCopyToClipBoardFormat(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetPrintDocumentName(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR ;
...
void CiPlotX::SetPrinterName(LPCTSTR newValue)
{
	static BYTE parms[] = VTS_BSTR ;
...
void CiPlotX::SetClipAnnotationsToAxes(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetBackGroundGradientEnabled(BOOL newValue)
{
	static BYTE parms[] = VTS_BOOL ;
...
void CiPlotX::SetBackGroundGradientDirection(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
LPDISPATCH CiPlotX::GetTable(long Index)
{
	LPDISPATCH result;
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetDataFileColumnSeparator(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
void CiPlotX::SetDataFileFormat(long newValue)
{
	static BYTE parms[] = VTS_I4 ;
...
LPDISPATCH CiPlotX::GetTableByName(LPCTSTR Value)
{
	LPDISPATCH result;
	static BYTE parms[] = VTS_BSTR ;
